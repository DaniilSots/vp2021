<?php
	...
	//lisan lehele juhuslikku foto
	$photo_dir = "photos/";
	//loen kataloogi sisu
	//$all_files = scandir($photo_dir);
	$all_files = array_slice(scandir($photo_dir), 2);
	//echo $all_files; ei ööta
	//var_dump($all_files);
	
	//kontrollin ja võttan ainult fotod
	...
	//jaga päev osadeks (kodutöö) + github
...
<body>
	...
	<p>Õppetöö toumub <a href="https://www.tlu.ee/dt">Tallinna Ülikooli Digitehnoloogiate instituudis</a>.</p>
	<img src="mida-pean-teadma-2021-est.jpg" alt="Tallinna Ülikooli pilt" width="600">
